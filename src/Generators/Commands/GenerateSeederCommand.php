...
use Aruberuto\Workflow\Generators\SeederGenerator;
    ...
    public function getArguments()
    {
        return [
            [
                ...
                'The name of model for which the Seeder is being generated.',
                null
            ],
        ];
    }
    ...
    public function getOptions()
    {
        return [
            ...
            [
                ...
                'The http base path where the seeder will be generated.',
                null
